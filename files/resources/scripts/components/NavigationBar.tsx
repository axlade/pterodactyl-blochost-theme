...
export default () => {
    ...
    return (
        <div className={'w-full shadow-md overflow-x-auto'} id={'NavigationBar'} style={{ background: 'var(--bh-surface)', borderBottom: '1px solid var(--bh-border)', transition: 'background 0.3s, border-color 0.3s' }}>
            <BeforeNavigation />
            ...
            <div className={'mx-auto w-full flex items-center h-[3.5rem] max-w-[1200px]'}>
                <div id={'logo'} className={'flex-1'}>
                    <Link
                        to={'/'}
                        className={'text-2xl font-header font-medium px-4 no-underline transition-colors duration-150'}
                        style={{ color: 'var(--bh-text)', transition: 'color 0.3s' }}
                    >
                        {name}
                    </Link>
                </div>
