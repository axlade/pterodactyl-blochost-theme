        ...
        <TitledGreyBox
            title={
                <p className='text-sm uppercase'>
                    {!variable.isEditable && (
                        <span className='text-xs py-1 px-2 rounded-full mr-2 mb-1' style={{ background: 'var(--bh-surface2)', color: 'var(--bh-text)', border: '1px solid var(--bh-border)', transition: 'background 0.3s, color 0.3s' }}>Read Only</span>
                    )}
                    {variable.name}
                </p>
            }
